...
if __name__ == "__main__":
    from my_Data_presocer_for_dql import DataProcessor
    import random


    data_batches = DataProcessor.get_betch_data("private/cryptoMinute/XRPUSDT.csv") # add data clean method to class
